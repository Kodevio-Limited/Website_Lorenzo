        ...
        <div className="w-full flex flex-col items-center gap-20">
          ...
          <div className="w-full flex justify-center items-start gap-20">
            <div className="w-96 inline-flex flex-col justify-start items-start gap-6">
              {notItems.map((item) => (
                <div key={item} className="self-stretch inline-flex justify-start items-center gap-5">
            ...
            <div className="w-[516px] h-96 relative bg-stone-900 rounded-2xl overflow-hidden shrink-0">
