...
<span className="text-amber-200 text-6xl md:text-7xl font-bold leading-tight md:leading-[110.82px]" style={{ fontFamily: "'Times New Roman', serif" }}>
          ...
          <motion.p
            ...
            className="w-full max-w-[802px] text-zinc-400 text-2xl md:text-3xl font-normal leading-8 md:leading-10"
          >
          ...
          <motion.div
            ...
            className="inline-flex justify-start items-center gap-6"
          >
            <motion.a
              href="/contact"
