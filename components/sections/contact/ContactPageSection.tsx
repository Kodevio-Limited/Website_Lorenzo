          ...
          >
            <div className="p-5 sm:p-8 lg:p-[53px]">
              <div className="flex flex-col items-start gap-3 sm:gap-5 mb-6 sm:mb-10">
                <div className="text-white text-2xl sm:text-3xl font-medium leading-8 sm:leading-10">Send a Message</div>
              ...
              <div className="flex flex-col items-start gap-6 sm:gap-10">
                ...
                <div className="w-full flex flex-col items-start gap-3 sm:gap-4">
                  <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Purpose of Inquiry *</label>
                  <div className="w-full px-4 sm:px-6 py-3 sm:py-3.5 bg-black rounded-sm flex flex-wrap items-center gap-4 sm:gap-6 lg:gap-28">
                    {[
                      ...
                      >
                        ...
                        <span className="text-white text-sm sm:text-lg font-medium leading-6 sm:leading-7">{opt.label}</span>
                      </button>
                    ))}
                  </div>
                </div>
                ...
                <div className="w-full flex flex-col lg:flex-row items-start gap-6 sm:gap-10 lg:gap-14">
                  <div className="w-full lg:w-96 flex flex-col items-start gap-3 sm:gap-4">
                    <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Name</label>
                    <div className="w-full pl-4 sm:pl-7 pr-3 sm:pr-4 py-3 sm:py-5 bg-neutral-600 rounded-sm flex items-center gap-2">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a3a3a3" strokeWidth="2" className="shrink-0 sm:w-6 sm:h-6">
                  ...
                  <div className="w-full lg:w-96 flex flex-col items-start gap-3 sm:gap-4">
                    <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Phone Number (Optional)</label>
                ...
                {/* Email */}
                <div className="w-full flex flex-col items-start gap-3 sm:gap-4">
                  <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Email</label>
                  <div className="w-full h-auto min-h-[48px] sm:h-16 pl-4 sm:pl-7 pr-3 sm:pr-4 py-3 sm:py-6 bg-neutral-600 rounded-sm flex items-center gap-2">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a3a3a3" strokeWidth="2" className="shrink-0 sm:w-6 sm:h-6">
                ...
                <div className="w-full flex flex-col lg:flex-row items-start gap-6 sm:gap-10 lg:gap-14">
                  <div className="w-full lg:w-96 flex flex-col items-start gap-3 sm:gap-4">
                    <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Service Required *</label>
                  ...
                  <div className="w-full lg:w-96 flex flex-col items-start gap-3 sm:gap-4">
                    <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Property Parish *</label>
                    <div className="w-full pl-4 sm:pl-7 pr-3 sm:pr-4 py-3 sm:py-5 bg-neutral-600 rounded-sm flex items-center justify-between gap-2">
                      <select
                        defaultValue=""
                        className="w-full bg-transparent text-neutral-400 text-sm sm:text-base font-medium leading-6 outline-none appearance-none"
                ...
                <div className="w-full flex flex-col items-start gap-4 sm:gap-6">
                  <div className="w-full flex flex-col items-start gap-3 sm:gap-4">
                    <label className="text-neutral-50 text-base sm:text-xl font-medium leading-6 sm:leading-7">Your Message</label>
                    <textarea
                      rows={5}
                  ...
                  {/* reCAPTCHA */}
                  <div className="w-full h-auto min-h-[64px] sm:h-20 bg-black rounded-sm overflow-hidden flex items-center px-3 sm:px-4 py-3">
                    <div className="w-full flex justify-between items-center gap-3">
                      <div className="flex items-center gap-2 sm:gap-2.5">
                        <div className="size-5 sm:size-6 relative shrink-0">
                          <div className="size-4 sm:size-[18px] left-[3px] top-[3px] absolute bg-green-500 rounded-sm" />
                        </div>
                        <span className="text-white text-base sm:text-xl font-normal leading-7">I am not a robot *</span>
                      </div>
                  ...
                  <div className="w-full flex items-start gap-2">
                    ...
                    <span className="text-zinc-500 text-sm sm:text-base font-normal leading-6">
                      ...
                      <Link href="/privacy-policy" className="text-amber-200 text-base sm:text-lg font-medium leading-6">Privacy Policy. *</Link>
                    </span>
                  </div>
                </div>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-4 sm:py-5 bg-gradient-to-b from-amber-200 via-orange-400 to-yellow-700 rounded-sm flex items-center justify-center gap-2 sm:gap-2.5 text-stone-900 text-lg sm:text-2xl font-medium leading-7 sm:leading-8 hover:opacity-90 transition-all"
                >
                  SEND MESSAGE
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className="text-stone-900 sm:w-5 sm:h-5">
          ...
          >
            ...
            >
              <div className="flex items-start gap-4 sm:gap-6">
                <div className="w-14 sm:w-16 h-16 sm:h-20 bg-stone-500 rounded-[3px] relative overflow-hidden flex items-center justify-center shrink-0">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fbbf24" strokeWidth="2" className="sm:w-7 sm:h-7">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.67 3.39 2 2 0 0 1 3.66 1.21h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.42-1.42a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z" />
                  </svg>
                </div>
                <div className="flex flex-col items-start gap-2 sm:gap-4 min-w-0">
                  <div className="text-neutral-400 text-xs sm:text-base font-medium leading-5 sm:leading-6">CALL US DIRECTLY</div>
                  <div className="text-white text-xl sm:text-3xl font-medium leading-7 sm:leading-10 break-words">USA OFFICE: (561) 639-8772</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start gap-4 sm:gap-6">
                ...
                <div className="flex flex-col items-start gap-2 sm:gap-4 min-w-0">
                  <div className="text-neutral-400 text-xs sm:text-base font-medium leading-5 sm:leading-6">EMAIL SUPPORT</div>
                  <div className="text-white text-xl sm:text-3xl font-medium leading-7 sm:leading-10 break-all">info@nexuspbs.net</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4 sm:gap-6 mb-6 sm:mb-[38px]">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fbbf24" strokeWidth="2" className="shrink-0 sm:w-7 sm:h-7">
                  <circle cx="12" cy="12" r="10" />
                  <polyline points="12 6 12 12 16 14" />
                </svg>
                <div className="text-white text-2xl sm:text-3xl font-medium leading-8 sm:leading-10">Business Hours</div>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-12 lg:gap-[72px]">
                <div className="w-full sm:w-auto flex flex-col items-start gap-4 sm:gap-7">
                  <div className="text-neutral-400 text-sm sm:text-lg font-normal leading-6 sm:leading-7">Monday - Friday</div>
                  <div className="text-neutral-400 text-sm sm:text-lg font-normal leading-6 sm:leading-7">Saturday</div>
                  <div className="text-neutral-400 text-sm sm:text-lg font-normal leading-6 sm:leading-7">Sunday</div>
                </div>
                <div className="w-full sm:w-auto flex flex-col items-start gap-4 sm:gap-7">
                  <div className="text-neutral-400 text-sm sm:text-lg font-normal leading-6 sm:leading-7">9:00 AM - 5:00 PM</div>
                  <div className="text-neutral-400 text-sm sm:text-lg font-normal leading-6 sm:leading-7">10:00 AM - 2:00 PM</div>
                  <div className="text-red-600 text-sm sm:text-lg font-normal leading-6 sm:leading-7">CLOSED</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col gap-5 sm:gap-6">
                <div className="flex items-center gap-4 sm:gap-6">
                  ...
                  <div className="text-white text-2xl sm:text-3xl font-medium leading-8 sm:leading-10">Service Area</div>
                </div>
                <div className="text-zinc-400 text-base sm:text-xl font-normal leading-6 sm:leading-7">
